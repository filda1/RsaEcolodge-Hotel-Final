...
<div class="container">
 ...
 <div class="modal fade seminor-login-modal"  id="myModal">
    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        ...
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
          ...
          <p class="lead mb-0" style="font-family:Century Gothic;">
          {{ __('messages.Cuerpo1') }}
      </p>
        </div>
      </div>
  ...
  <br> <br><br><br><br><br>
   ...
   <!-- About 
   <section class="testimonials text-center " style="background-color:#E0E0E0;">
    <div class="container" >
      <h2 class="mb-5">{{ __('messages.Quem') }}</h2>
      <div class="row" >
   ...
   <section class="testimonials text-center " style="background-color:#E0E0E0;">
    <div class="container" >
      ...
      <div class="row" >
            ...
            <p align="left"  style="font-family:Century Gothic;font-size:18px">
            {{ __('messages.Or') }}
          </p>
        <!-- Carrosel -->
