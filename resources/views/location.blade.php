...
<h3 style="color:#47775D;font-weight:bold;font-family:Century Gothic;">{{ __('messages.Indicações') }}</h3><br>
<h5 style="font-family:Century Gothic;font-size:18px"><i class='' style='font-size:24px; '></i>&nbsp; &nbsp;{{ __('messages.Siga') }}</h5>
