...
class ValidationController extends Controller
{
    function index()
    {
       ...
       if ( $comodidades<=100 ){
        ...
        return view('validation',compact('funcionarios', 'comodidades', 'limpeza', 'conforto', 'qualidade', 'localizacao', 'wifi', 'total','pfuncionarios','pcomodidades','plimpeza', 'porconforto', 'porqualidade', 'porlocalizacao','porcewifi'));
    }
